...
using owncloudsharp.Core.Exceptions;
using owncloudsharp.Core.Types;
using owncloudsharp.Core.Core;
using System.Linq;

namespace owncloudsharp.Core
{
    /// <summary>
